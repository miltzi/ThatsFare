...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { description: @party.description, location: @party.location, name: @party.name }
    end
  ...
  test "should update party" do
    patch :update, id: @party, party: { description: @party.description, location: @party.location, name: @party.name }
    assert_redirected_to party_path(assigns(:party))
  end
